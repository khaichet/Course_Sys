        ...
        <div className="md:hidden bg-white px-4 py-4 border-t border-gray-200">
          {isAuthenticated ? (
            <div className="space-y-4">
              <a
                href="/courses"
                className="block py-2 px-3 hover:bg-gray-100 rounded-lg transition font-medium text-gray-700"
              ...
              <div className="py-2 px-3 border-t border-gray-200">
                <p className="text-sm mb-3 truncate text-gray-600">
                  Email: {userEmail}
                </p>
                <button
                  onClick={() => {
                  ...
                  className="w-full bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg font-medium transition min-h-[44px]"
                >
                  Đăng Xuất
                </button>
              </div>
